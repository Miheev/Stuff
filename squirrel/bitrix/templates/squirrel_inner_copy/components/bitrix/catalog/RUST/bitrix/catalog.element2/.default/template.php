...
<div class="catalog-element"> 	
  ...
  <p><?=$arResult["CAT_PRICES"][$code]["TITLE"];?>:&nbsp;&nbsp; 					<?if($arPrice["DISCOUNT_VALUE"] < $arPrice["VALUE"]):?> 						<s><?=$arPrice["PRINT_VALUE"]?></s> <span class="catalog-price"><?=$arPrice["PRINT_DISCOUNT_VALUE"]?></span> 					<?else:?> 						<span class="catalog-price"><?=$arPrice["PRINT_VALUE"]?></span> 					<?endif?> 					</p>
 				<?endif;?> 			<?endforeach;?> 			
  <p> 			<?if($arParams["DISPLAY_COMPARE"]):?> 				<noindex> 				<a href="<?echo $arOffer["COMPARE_URL"]?>" rel="nofollow" ><?echo GetMessage("CT_BCE_CATALOG_COMPARE")?></a>&nbsp; 				</noindex> 			<?endif?> 			<?if($arOffer["CAN_BUY"]):?> 				<?if($arParams["USE_PRODUCT_QUANTITY"]):?> 					</p>
<form action="&lt;img id=" bxid_581505"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0">&quot; method=&quot;post&quot; enctype=&quot;multipart/form-data&quot;&gt; 					
    <table border="0" cellspacing="0" cellpadding="2"> 						
      <tbody>
        <tr valign="top"> 							<td><?echo GetMessage("CT_BCE_QUANTITY")?>:</td> 							<td> 								<input type="text" name="&lt;img id=" bxid_800536"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;1&quot; size=&quot;5&quot;&gt; 							</td> 						</tr>
       					</tbody>
    </table>
   					<input type="hidden" name="&lt;img id=" bxid_162512"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;BUY&quot;&gt; 					<input type="hidden" name="&lt;img id=" bxid_697235"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo $arOffer["ID"]?>&quot;&gt; 					<input type="submit" name="&lt;img id=" bxid_698171"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo GetMessage("CATALOG_BUY")?>&quot;&gt; 					<input type="submit" name="&lt;img id=" bxid_777791"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo GetMessage("CT_BCE_CATALOG_ADD")?>&quot;&gt; 					</form> 				<?else:?> 					<noindex> 					<a href="<?echo $arOffer["BUY_URL"]?>" rel="nofollow" ><?echo GetMessage("CATALOG_BUY")?></a> 					&nbsp;<a href="<?echo $arOffer["ADD_URL"]?>" rel="nofollow" ><?echo GetMessage("CT_BCE_CATALOG_ADD")?></a> 					</noindex> 				<?endif;?> 			<?elseif(count($arResult["CAT_PRICES"]) > 0):?> 				<?=GetMessage("CATALOG_NOT_AVAILABLE")?> 			<?endif?> 			
  <p></p>
  ...
  <br />
 		<?endif?> 		<?if($arResult["CAN_BUY"]):?> 			<?if($arParams["USE_PRODUCT_QUANTITY"] || count($arResult["PRODUCT_PROPERTIES"])):?> 				<form action="&lt;img id=" bxid_356037"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0">&quot; method=&quot;post&quot; enctype=&quot;multipart/form-data&quot;&gt; 				
    <table border="0" cellspacing="0" cellpadding="2"> 				 					
      <tbody>
        <?if($arParams["USE_PRODUCT_QUANTITY"]):?><tr valign="top" > 						<td><?echo GetMessage("CT_BCE_QUANTITY")?>:</td> 						<td> 							<input type="text" name="&lt;img id=" bxid_854875"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;1&quot; size=&quot;5&quot;&gt; 						</td> 					</tr>
        ...
        <?foreach($arResult["PRODUCT_PROPERTIES"] as $pid => $product_property):?><tr valign="top" > 						<td><?echo $arResult["PROPERTIES"][$pid]["NAME"]?>:</td> 						<td> 						<?if(
						...
						):?> 							<?foreach($product_property["VALUES"] as $k => $v):?> 								<label><input type="radio" name="&lt;img id=" bxid_144669"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />[<?echo $pid?>]&quot; value=&quot;<?echo $k?>&quot; <?if($k == $product_property["SELECTED"]) echo '"checked"'?>&gt;<?echo $v?></label>
            <br />
           							<?endforeach;?> 						<?else:?> 							<select name="&lt;img id=" bxid_452551"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0">[]&quot;&gt; 								 									<option value="&lt;img id=" bxid_50723"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0">&quot; &gt;</option> 								 							</select> 						<?endif;?> 						</td> 					</tr>
       				
        <?endforeach;?>
       				</tbody>
    </table>
   				<input type="hidden" name="&lt;img id=" bxid_20844"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;BUY&quot;&gt; 				<input type="hidden" name="&lt;img id=" bxid_70462"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo $arResult["ID"]?>&quot;&gt; 				<input type="submit" name="&lt;img id=" bxid_356169"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo GetMessage("CATALOG_BUY")?>&quot;&gt; 				<input type="submit" name="&lt;img id=" bxid_845412"="" src="/bitrix/images/fileman/htmledit2/php.gif" border="0" />&quot; value=&quot;<?echo GetMessage("CATALOG_ADD_TO_BASKET")?>&quot;&gt; 				</form> 			<?else:?> 				<noindex> 				<a href="<?echo $arResult["BUY_URL"]?>" rel="nofollow" ><?echo GetMessage("CATALOG_BUY")?></a> 				&nbsp;<a href="<?echo $arResult["ADD_URL"]?>" rel="nofollow" ><?echo GetMessage("CATALOG_ADD_TO_BASKET")?></a> 				</noindex> 			<?endif;?> 		<?elseif((count($arResult["PRICES"]) > 0) || is_array($arResult["PRICE_MATRIX"])):?> 			<?=GetMessage("CATALOG_NOT_AVAILABLE")?> 		<?endif?> 	<?endif?> 		
  <br />
...
<a name="more_photo"></a>
  ...
  <br />
<a href="<?=$arResult["SECTION"]["SECTION_PAGE_URL"]?>" ><?=GetMessage("CATALOG_BACK")?></a>  1	<?endif?> </div>
