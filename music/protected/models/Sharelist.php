...
/**
 * This is the model class for table "sharelist".
 *
 * The followings are the available columns in table 'sharelist':
 * @property string $id
 ...
 * @property Users $user
 */
class Sharelist extends CActiveRecord
{
	/**
	 ...
	 * @return Sharelist the static model class
	 */
