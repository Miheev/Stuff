...
$salt='imo3diniet4v9m5h';                          // Salt. A salt consists of random chars used as one of the inputs of a one-way function (MD5 hash). DO NOT CHANGE!
...
$dbss['pass']='mintsql';                  // Database password  (not used with sqlite)
$dbss['name']='music_00';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
$dbss['prfx']='bl';                  // Table prefix for BLAB! tables, default 'blab7'
