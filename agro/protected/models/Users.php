...
class Users extends CActiveRecord
{
    ...
    const ROLE_TECH_DIRECTOR = 'techdir';
    const ROLE_GEN_DERECTOR = 'gendir';
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('login, pass, name, phone, role', 'length', 'max'=>100),
            array('pass', 'compare'),
            array('pass_repeat', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, login, pass, name, phone, role, available', 'safe', 'on'=>'search'),
        );
    }
...
//    }
    ...
    public static function getRoles() {
        return array (
            self::ROLE_REQUESTER => 'Заявитель',
            self::ROLE_ADMINISTRATOR => 'Администратор',
            self::ROLE_SUPPLIER => 'Снабженеец',
            self::ROLE_ACCOUNTANT => 'Бухгалтер материалист',
            self::ROLE_FINANCIER => 'Финансист',
            self::ROLE_TECH_DIRECTOR => 'Технический директор',
            self::ROLE_SIGNER => 'Генеральный директор',
