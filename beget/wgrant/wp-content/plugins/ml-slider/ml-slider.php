...
class MetaSliderPlugin {
    ...
    private function plugin_classes() {
        ...
        return array(
            ...
            'metabxslider'        => METASLIDER_PATH . 'inc/slider/metaslider.bx.class.php',
    ...
    public function set_slider( $id, $shortcode_settings = array() ) {
        ...
        if ( ! in_array( $type, array( 'flex', 'coin', 'nivo', 'responsive', 'bx' ) ) ) {
            $type = 'flex';
        }
    ...
    private function create_slider( $type, $id, $shortcode_settings ) {
        ...
        switch ( $type ) {
            ...
            case( 'bx' ):
                return new MetaBxSlider( $id, $shortcode_settings );
            default:
                return new MetaFlexSlider( $id, $shortcode_settings );
                                                    ...
                                                    <?php
                                                        $aFields = array(
                                                            'type' => array(
                                                                ...
                                                                'options' => array(
                                                                    ...
                                                                    'bx'       => array( 'label' => __( "Bx Slider", "metaslider" ) )
                                                                )
                                                            ),
                                                            'width' => array(
                                                                'priority' => 10,
                                                                ...
                                                                'class' => 'coin flex responsive nivo bx',
                                                            ...
                                                            'params' => array(
                                                                'priority' => 153,
                                                                'type' => 'textarea',
                                                                'label' => __( "Params Field", "metaslider" ),
                                                                'class' => 'option bx',
                                                                'helptext' => __( "Set the parametrs, one per line", "metaslider" ),
                                                                'value' => $this->slider->get_setting( 'params' ) == 'false' ? '' : $this->slider->get_setting( 'params' )
                                                            ),
                                                            'bx_width' => array(
                                                                'priority' => 148,
                                                                'type' => 'textarea',
                                                                'label' => __( "Adjustment Rules", "metaslider" ),
                                                                'class' => 'option bx',
                                                                'helptext' => __( "Slider Width Adjustment Rules", "metaslider" ),
                                                                'value' => $this->slider->get_setting( 'bx_width' ) == 'false' ? '' : $this->slider->get_setting( 'bx_width' )
                                                            ),
                                                        );
                                                        ...
                                                        if ( $max_tabs && count( $this->all_meta_sliders() ) > $max_tabs ) {
                                                            $aFields['title'] = array(
                                                                'type' => 'title',
                                                                'priority' => 5,
                                                                'class' => 'option flex nivo responsive coin bx',
                                                                'value' => $title,
