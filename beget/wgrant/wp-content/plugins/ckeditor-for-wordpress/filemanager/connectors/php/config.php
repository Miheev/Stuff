...
$Config['UserFilesAbsolutePath'] = $ckeditor_wordpress->user_files_absolute_path;
...
$Config['AllowedExtensions']['Files']	= explode(',', $ckeditor_wordpress->options['upload']['files_allowed_ext']) ;
$Config['DeniedExtensions']['Files']		= array() ;
$Config['FileTypesPath']['Files']		= $Config['UserFilesPath'] . 'file/' ;
$Config['FileTypesAbsolutePath']['Files']= ($Config['UserFilesAbsolutePath'] == '') ? '' : $Config['UserFilesAbsolutePath'].'file/' ;
$Config['QuickUploadPath']['Files']		= $Config['FileTypesPath']['Files'] ;
$Config['QuickUploadAbsolutePath']['Files']= $Config['FileTypesAbsolutePath']['Files'] ;

$Config['AllowedExtensions']['Images']	= explode(',', $ckeditor_wordpress->options['upload']['images_allowed_ext']) ;
