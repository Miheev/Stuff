...
<div class="bx_page">
  ...
  <p>В поле <b>Количество</b> вы можете изменить количество товара для покупки. После изменения количества товара необходимо нажать кнопку <b>Пересчитать</b> для пересчета итоговой суммы заказа. 	</p>
