...
?><div class="RightColumnProducts <? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>"><?
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>" id="<? echo $strMainID; ?>">
<div class="RightColumnProductsName"><? echo $arItem['NAME']; ?></div>
<!--<div class="RightColumnProductsImg"
 id="<? echo $arItemIDs['PICT']; ?>"
	...
	{
		?><div class="RightColumnProductsImg" id="<? echo $arItemIDs['SECOND_PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
	...
	?>
<div class="RightColumnProductsPrice">
	<div id="<? echo $arItemIDs['PRICE']; ?>" class="ProductsPriceCen"><span><?
	if (!empty($arItem['MIN_PRICE']))
	{
		...
		?></span></div>
<div class="ProductsPricePod"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $arItem['NAME']; ?>">Подробнее</a></div>
</div>
