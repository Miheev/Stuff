	...
	<?foreach($arResult["SEARCH"] as $arItem):?>
    	<?
			if ($arItem["MODULE_ID"] == 'iblock'):
				...
				if ($i = $img->Fetch()):
echo '<table width=100% cellpadding=0 cellspacing="0" border="0"><tr><td width=150 style="padding-right:10px;" align="center"><img src="/upload/'.$i["SUBDIR"].'/'.$i["FILE_NAME"].'" width="'.$i["WIDTH"].'" height="'.$i["HEIGHT"].'"></td><td valign="top">';
				else:
					echo '<table width=100% cellpadding=0 cellspacing="0" border="0"><tr><td width=150 style="padding-right:10px;" align="center"><img src="/bitrix/templates/im_webpro/components/bitrix/catalog/catalogue_rows1/bitrix/catalog.section/.default/images/no_photo.png"></td><td valign="top">';
				endif;
