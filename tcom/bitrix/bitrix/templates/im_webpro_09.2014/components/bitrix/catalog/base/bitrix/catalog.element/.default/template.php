...
if (!empty($arResult['DETAIL_PICTURE']) && count($arResult['MORE_PHOTO']) > 1)
    array_unshift($arResult['MORE_PHOTO'], $arResult['DETAIL_PICTURE']);
reset($arResult['DETAIL_PICTURE']);
$arFirstPhoto = current($arResult['MORE_PHOTO']);
?>
	<div class="bx_item_container">
		<div class="bx_lt">
            <h1 class="head"><?=$arResult["NAME"]?></h1>
<div class="bx_item_slider clearfix" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
...
?>
    <div class="item_current_price" id="<? echo $arItemIDs['PRICE']; ?>">
        <p class="result_price simple nowrap">
            <?
            $tmp= str_replace('руб.', 'Р', $arResult['MIN_PRICE']['PRINT_DISCOUNT_VALUE']);
            echo $tmp;
            ?>
        </p>
    </div>
    <div class="clearfix price_ext">
        <div class="left">
        ...
        {
            ?>
            <div class="right bx_optionblock">
                <?
                if ($useVoteRating)
                {
...
<!--	<span class="item_section_name_gray">--><?// echo GetMessage('CATALOG_QUANTITY'); ?><!--</span>-->
	<div class="item_buttons vam">
        ...
        <div class="buttons">
            <span class="cart-btn product-btn">
            <a href="<?=$arResult['ADD_URL']?>">В корзину</a>
        </span>
		<span class="buy-btn product-btn">
			<a href="javascript:void(0);" id="<? echo $arItemIDs['BUY_LINK']; ?>">Купить</a>
		</span>
        </div>
        <div class="compare">
            <?
    ...
    <div class="prod-description">
        ...
        <p>Если товара нет в наличии, позвоните нам и мы расскажем когда он будет</p>
        <p>Для дополнительной информации по товару звоните по телефону:<br /><a class="simple nowrap" href="tel:+74953089022">+7 (495) 308-9022</a></p>
    </div>
<?
...
{
    $_POST['prod_detail']= $arResult['DETAIL_TEXT'];
}
?>
		<div class="bx_lb">
<div class="tac ovh">
