		...
		if (!empty($arSource))
		{
			?>
					...
					foreach ($arSource as $arProperties)
					{
                        ...
                        elseif ($arProperties["TYPE"] == "hidden")
                        {
                            ?>
                            <div class="row-hidden clearfix">
                                    <input type="hidden" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">
                            </div>
                        <?
                        }
