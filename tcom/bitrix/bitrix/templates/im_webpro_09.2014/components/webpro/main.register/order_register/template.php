...
<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
    <div class="block form">
        ...
        ?>
        <input size="30" type="text" name="REGISTER[NAME]" placeholder="ФИО *">
    ...
    <div class="block text">
        <div class="buttons">
            <div class="conditions">
                ...
                <p>Рег истрируясь на сайте, Вы дайте согласие на обработку и хранение указанных персональных данных.</p>
            </div>
            <div class="cond-ck clearfix">
...
<script>
    $(document).ready(function(){
        $('.cond-ck a').click(function(e){
            e.preventDefault();

            $('.conditions').stop(true, true);
