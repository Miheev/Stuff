...
layout_hfix= function() {
    setTimeout(function(){
        hbase= $('.main>.center').height();
        min_visible= $('.cat-menu').height();
        $('aside .hideable').height(hbase-min_visible);


        //if ($('.discount-stuff').length) {
        //    obj= $('.discount-stuff .stuff-item');
        //
        //    hdelta= obj.first().position().top - $('.cat-menu').position().top;
        //    hdelta= hbase - hdelta;
        //    mstuff= parseInt(obj.eq(1).css('margin-top'));
        //
        //    from= 0;
        //    obj.each(function(id){
        //        if (hdelta > 0) {
        //            hdelta-= $(this).height()+mstuff;
        //        }
        //        else {
        //            from= id;
        //            return;
