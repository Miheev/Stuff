...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="CommodityDiscount_"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<div class="CommodityDiscountImg"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" style="background-image:url(<? echo $arItem['PREVIEW_PICTURE_SECOND']['SRC']; ?>)">
	<?
...
*/?><div class="CommodityDiscountName"><font><? echo $arItem['NAME']; ?></font></div>
<div class="CommodityDiscountPrice"><div class="CommodityDiscountPriceB">
<?
	if (!empty($arItem['MIN_PRICE']))
	{
		...
		{
			echo floor(($arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE'])*1.2);echo "&nbsp;руб";
		}
		if ('Y' == $arParams['SHOW_OLD_PRICE'] && $arItem['MIN_PRICE']['DISCOUNT_VALUE'] < $arItem['MIN_PRICE']['VALUE'])
		{
	?> <span><stike><? echo floor(($arItem['MIN_PRICE']['PRINT_VALUE'])*1.2); ?>&nbsp;руб</stike></span><?
		}
	}
	?>
...
</div><div class="CommodityDiscountPriceS">/</div><div class="CommodityDiscountPriceN"><?
	if (!empty($arItem['MIN_PRICE']))
	{
		if ('N' == $arParams['PRODUCT_DISPLAY_MODE'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
		{
		...
		{
			echo  floor($arItem['MIN_PRICE']['VALUE']);?>&nbsp;руб<?
		}
		if ('Y' == $arParams['SHOW_OLD_PRICE'] && $arItem['MIN_PRICE']['DISCOUNT_VALUE'] < $arItem['MIN_PRICE']['VALUE'])
		{
	...
	?></div></div>
<div class="CommodityDiscountMore"><a
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
			title="<? echo $strTitle; ?>">
		Подробнее</a></div>
<?
