												...
												?>
													<td id="quantity_control">
														<div class="quantity_control">
															<a href="javascript:void(0);" class="plus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', '<?=$useFloatQuantity?>');"></a>
															<a href="javascript:void(0);" class="minus" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', '<?=$useFloatQuantity?>');"></a>
														</div>
													</td>
												<?
												endif;
