...
<?
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			echo '<table width=100% cellpadding=5 cellspacing=0><tr><td width=50% class="MainRightColumnContent" valign=top>';
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				if ($parentSection >= floor($parentSections/2)-1 && $arSection['RELATIVE_DEPTH_LEVEL'] == 1 && $col2 == false): 
					echo '</td><td class="MainRightColumnContent" width=50% valign=top>'; 
					$col2 = true;
				endif;
