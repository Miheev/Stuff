...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if ('' != $arParams['LABEL_PROP'] && isset($arItem['PROPERTIES'][$arParams['LABEL_PROP']]))
		{
			$arProp = $arItem['PROPERTIES'][$arParams['LABEL_PROP']];
			if (!empty($arProp['VALUE']))
			{
				...
				{
					$arItem['LABEL_VALUE'] = (is_array($arProp['VALUE'])
				...
				if (isset($arItem['DISPLAY_PROPERTIES'][$arParams['LABEL_PROP']]))
