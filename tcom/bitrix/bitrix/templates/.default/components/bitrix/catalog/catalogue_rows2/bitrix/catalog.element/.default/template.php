...
?>
	<div class="MainRightColumnContent">
<div class="bx_item_slider">
	<!--<div class="bx_bigimages">-->
		<div class="MainRightColumnImg">
...
?>
			...
			<div class="MainRightColumnMain">
		<div class="MainRightColumnName">
<?
	echo ('html' == $arResult['PREVIEW_TEXT_TYPE'] ? $arResult['PREVIEW_TEXT'] : '<h1>'.$arResult['PREVIEW_TEXT'].'</h1>');
?>
</div>
		
		<div class="MainRightColumnZakaz">
<?
...
?>
	...
	<h1 id="<? echo $arItemIDs['PRICE']; ?>"><? echo $arResult['MIN_PRICE']['PRINT_DISCOUNT_VALUE']; ?></h1>
...
?>
<div class="MainRightColumnZakazMain">
<div class="MainRightColumnZakazCol">
<?
...
if ('Y' == $arParams['USE_PRODUCT_QUANTITY'])
{
    ...
    <h5>В наличии <b><?=$arResult["CATALOG_QUANTITY"]?></b> шт.</h5>
    <?
	if ($USER->IsAuthorized()):
?>
<h5><? echo GetMessage('CATALOG_QUANTITY'); ?></h5>
	<div class="item_buttons vam">
    <span class="item_buttons_counter_block">
		<div class="MainRightColumnZakazPlus">
		...
		<span class="ZakazButtom"> 
			<a href="javascript:void(0);" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><? echo $buyBtnMessage; ?></a>
	<?
	endif;
...
{
?>
	<div class="MainRightColumnOpis">
		<span><? echo "Описание"?></span>
<div class="MainRightColumnOpisCont"<?
