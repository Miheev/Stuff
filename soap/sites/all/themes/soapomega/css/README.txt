...
To use these stylesheets, rename the files and soapomega with the name of your theme.
...
soapomega-alpha-default-narrow.css  
...
soapomega-alpha-default-normal.css
...
soapomega-alpha-default-wide.css
