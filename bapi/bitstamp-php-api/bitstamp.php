...
class Bitstamp
{
	...
	*/
    ...
    function ripple_withdrawal(){
        $ripple_withdrawal = $this->bitstamp_query('ripple_withdrawal');
        $this->ripple_withdrawal = $ripple_withdrawal; // Another variable to contain it.
        return $ripple_withdrawal;
    }
     ...
     *
     */
    function ripple_address(){
        $ripple_address = $this->bitstamp_query('ripple_address');
        $this->ripple_address = $ripple_address; // Another variable to contain it.
