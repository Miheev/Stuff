...
<div class="hideable">
<?if (preg_match('/(^catalog)|(^news)|(^personal)/', $page_class)) :?>
    ...
    <?$APPLICATION->IncludeComponent("bitrix:catalog.section", "stuff_discount_catalog", Array(
...
<?else :?>
    <section class="discount clearfix">
        ...
        <a class="abutton gradient" href="/catalog/skidki">Смотреть все товары</a>
    </section>
<?endif?>
</div>