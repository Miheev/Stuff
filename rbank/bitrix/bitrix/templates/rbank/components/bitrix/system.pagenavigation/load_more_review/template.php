...
<div class="more-btn" id="more-review-btn">
...
<?else:?>
	...
	<?if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		<a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>">Ещё отзывы</a>
	<?else:?>
		<a class="totop" href="javascript:void(0)">В начало</a>
	<?endif?>
