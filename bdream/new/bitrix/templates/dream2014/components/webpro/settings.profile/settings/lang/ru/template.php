...
$MESS["PERSONAL_ACOUNT"] = "Личный кабинет: настройки";
$MESS["BACK"] = "Вернуться назад";
$MESS["PERSONAL_INFORMATION"] = "Личные данные";
$MESS["NA_RODNOM"] = "На родном языке";
$MESS["IN_ENGLISH"] = "На английском";
$MESS["WEB_SITES"] = "Вебсайты";
$MESS["ADD"] = "Добавить";
$MESS["DROP"] = "Удалить";
$MESS["NEW_PASSWOR"] = "Изменить пароль";
$MESS["NEW_PASSWOR_COM"] = "Для надёжности пароля сочитайте цифры и буквы, некому не говорите свой пароль.";
$MESS["LOAD_PHOTO"] = "Загрузить фото";
$MESS["MINI_PHOTO"] = "Миниатюра";
$MESS["USER_DELETE"] = "Удалить Вашу учётную запись";
$MESS["USER_DELETE_COM"] = "При удалении учётной записи все данные по Вашей мечте будут удалены.";
$MESS["NEW_EMAIL"] = "Сменить Ваш email адрес <span>(emailadres@email.com)</span>";
$MESS["NEW_EMAIL_COM"] = "Используйте существующий адрес, после изменения на него придёт письмо с дальнейшими указаниями.";
$MESS["MAIN_DELETE"] = "Удалить";
$MESS["NEWS_RSS"] = "Подписаться на DreamStart новости";
$MESS["NEWS_RSS_COM"] = "В рассылке Вам будет приходить информация по действиям с Вашей мечтой, избранным и общие новости проекта.";
$MESS["NEWS_RSS_ADD"] = "Подписаться";
$MESS["MINI_PHOTO"] = "Миниатюра";
$MESS["MINI_PHOTO"] = "Миниатюра";
$MESS["MINI_PHOTO"] = "Миниатюра";
$MESS["MINI_PHOTO"] = "Миниатюра";
