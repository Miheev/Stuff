...
$MESS["WEB_SITES"] = "Сайты";
$MESS["WEB_SITES_COM"] = "Вы можите добавить интересные сайты, или Ваши страницы из соц. сетей.";
$MESS["ADD"] = "Добавить";
$MESS["DROP"] = "Удалить";
$MESS["NEW_PASSWOR"] = "Смена пароля";
$MESS["LOAD_PHOTO"] = "Загрузить фото";
$MESS["MINI_PHOTO"] = "Миниатюра";

$MESS["NAME"] = "Имя";
$MESS["LAST_NAME"] = "Фамилия";
$MESS["IN_ENGLISH_NAME"] = "First Name";
$MESS["IN_ENGLISH_LAST_NAME"] = "Last Name";
$MESS["NAME_LAST_NAME_COM"] = "Укажите имя и фамилию на английском, чтобы люди с других стран могли обращаться к Вам";
$MESS["USER_BIRTHDAY_DT"] = "День рождения";
$MESS["USER_PLACE"] = "Расположение";
$MESS["USER_PLACE_SELECT"] = "Укажите своё место проживания.";
