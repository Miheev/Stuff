						...
						switch ($INPUT_TYPE):
							case "USER_TYPE":
								for ($i = 0; $i<$inputNum; $i++)
								{
									...
									<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="5" name="PROPERTY[43][0][VALUE][TEXT]"><?=$value["TEXT"]?></textarea>
							...
							/*
								...
								<textarea cols="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>" rows="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["ROW_COUNT"]?>" name="PROPERTY[<?=$propertyID?>][0]"><?=$arResult["ELEMENT"][$propertyID]?></textarea>
								<?
								break;
							case "T":
								for ($i = 0; $i<$inputNum; $i++)
