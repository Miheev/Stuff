...
<!--			<td>--><?//=GetMessage('MAKI_ORDER_HOUSE_FIELD_NAME')?><!--</td>-->
			<td>
				...
				<input placeholder="Имя" type="text" name="NAME" value="<?=$arResult['NAME']?>" />
			</td>
		</tr>
<!--		<tr>-->
...
<!--			<td>--><?//=GetMessage('MAKI_ORDER_HOUSE_FIELD_PHONE')?><!--</td>-->
			<td>
				...
				<input placeholder="Телефон" type="text" name="PHONE" value="<?=$arResult['PHONE']?>" />
			</td>
		</tr>
		<tr>
<!--			<td>--><?//=GetMessage('MAKI_ORDER_HOUSE_FIELD_EMAIL')?><!--</td>-->
			<td>
				...
				<input placeholder="Email" type="text" name="EMAIL" value="<?=$arResult['EMAIL']?>" />
			</td>
		</tr>
		<tr>
<!--			<td>--><?//=GetMessage('MAKI_ORDER_HOUSE_FIELD_DESCRIPTION')?><!--</td>-->
			<td>
				...
				<textarea rows="6" placeholder="Описание" name="DESCRIPTION"><?=$arResult['DESCRIPTION']?></textarea>
			</td>
		</tr>
<!--		<tr>-->
<!--			<td>&nbsp;</td>-->
