  ...
  <div class="catalog-element-center">
        ...
        <div class="catalog-element-center-leftbot" id="thumbs">
            <ul class="thumbs noscript">
                <?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
                    ...
                    <?php if($arProperty['CODE'] == 'maki_photo') :
                        foreach ($arProperty['FILE_VALUE'] as $img) :
                            ?>
                            <li>
                                <a class="thumb" href="<?=$img['SRC']?>" data-height="<?=$img['HEIGHT']?>" title="<?=$img['ORIGINAL_NAME']?>">
                                    <img src="<?=$img['SRC']?>" width="60" height="60" alt="<?=$img['ORIGINAL_NAME']?>" class="thumbs">
                                </a>
                            </li>
                        <?php endforeach;
                    endif; ?>
    ...
    <div class="catalog-element-center-right">
        ...
        <div class="element-properties">
    	    <?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
               <? if($arProperty['CODE'] == 'maki_photo'|| $arProperty['CODE'] == 'maki_houses' || $arProperty['CODE'] == 'maki_plans' || $arProperty['CODE'] == 'maki_elevations' || $arProperty['CODE'] == 'maki_similar'):?>
