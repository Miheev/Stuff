      ...
      <div class="catalog-element-top-left" id="thumbs" >
    	    ...
    	    <?foreach($arResult["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
               ...
               <? if($arProperty['CODE'] == 'maki_houses'):?>
                     ...
                     <li><a class="thumb" href="<?=CFile::GetPath($Property['BIG'])?>"><img src="<?=CFile::GetPath($Property['SMALL'])?>" width="60" height="60" alt="" class="thumbs"></a>bug</li>
                     <?endforeach?>
               <? endif;?>

               <? if($arProperty['CODE'] == 'maki_plans' ):?>

                    <?foreach($arProperty['VALUE'] as $Property2):?>

                        <? $bigpath2 = CFile::GetPath($Property2); ?>
                        <li><a class="thumb" href="<? echo $bigpath2;?>"><? echo CFile::ShowImage($Property2, 60, 60, "border=0 alt='".$bigpath2."' class='thumbs'  width='60' height='60'  ", "", false);?></a></li>
                     <?endforeach?>
               <? endif;?>

               <? if($arProperty['CODE'] == 'maki_elevations' ):?>
                    <?foreach($arProperty['VALUE'] as $Property3):?>
                        <? $bigpath3 = CFile::GetPath($Property3); ?>
                        <li><a class="thumb" href="<? echo $bigpath3;?>"><? echo CFile::ShowImage($Property3, 60, 60, "border=0 alt='".$bigpath3."' class='thumbs' width='60' height='60'   ", "", false);?></a></li>
                     <?endforeach?>
               <? endif;?>
    		<?endforeach?>
            </ul>
