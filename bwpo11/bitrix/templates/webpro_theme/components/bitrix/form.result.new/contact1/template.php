...
?>
    ...
    <div class="appnitro">
        ...
        <?php echo $arResult["QUESTIONS"]['SIMPLE_QUESTION_490']["HTML_CODE"]; ?>
        <?php echo $arResult["QUESTIONS"]['SIMPLE_QUESTION_808']["HTML_CODE"]; ?>
        <div class="chek">
            <?php echo $arResult["QUESTIONS"]['SIMPLE_QUESTION_772']["HTML_CODE"]; ?>
        </div>
        <p style=" margin-bottom: -10px; ">Комментарий к заказу<span
                style="color: rgb(175, 0, 0); font-size: 11px;">(Обязательное поле)</span>:
        </p>
        <?php echo $arResult["QUESTIONS"]['SIMPLE_QUESTION_334']["HTML_CODE"]; ?>
