...
(function($){
    ...
    function showPic() {
        ...
        //check size
        if(zoomHeight > screenHeight - 145) {
            zoomHeight = screenHeight - 145;
            zoomWidth = zoomHeight * ratio;
        } else if(zoomWidth > screenWidth - 150) {
            zoomWidth = screenWidth - 150;
        ...
        if(placeToCenter === false) {
            ...
            //check place
            localTop = (screenHeight / 2) - (zoomHeight / 2)+100;
