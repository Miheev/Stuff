...
if ( isset( $_REQUEST["customizer_action"] ) && $_REQUEST["customizer_action"] == "post_control" ){
...
} elseif ( isset( $_REQUEST["customizer_action"] ) && $_REQUEST["customizer_action"] == "post_section" ){
...
//answer to addSection part 2
		...
		<div id="customizer_add_section_active">
				...
				<ul class="customize-section-content">
					...
					<li class="customize-control customize-control-text">
						<label for="customizer_add_section_ID"><span class="customize-control-title">Section ID</span>
							<input form="customizer_add_section_form" type="text" id="customizer_add_section_ID" class="customizer-type-id" name="customizer_add_section_ID" placeholder="unique ID" />
						</label>
					</li>
          ...
          <li class="customize-control customize-control-text">
            ...
            <label for="customizer_add_first_ID"><span class="customize-control-title">Unique ID</span>
							<input form="customizer_add_section_form" type="text" id="customizer_add_first_id" name="customizer_add_first_id" class="customizer-type-id"  />
						</label>
					</li>
					<li class="customize-control customize-control-text">
 ...
 update_option('customizer_array', $nu_array);
		...
		foreach ($options as $o) {
			if (isset($o["priority"])) {
				if ( $o["priority"] != 'undefined' && $o["priority"] ){
					//echo "'" . $o["id"] . "':'" . $o["priority"]."',\n";
					$opts[$o["id"]]=$o["priority"];
				}
			}
		}
	...
	/* We are removing a control here! */
 $options = get_option( "customizer_array" );
 $rid     = $_REQUEST["rid"];
 $nu_array = array();
...
?>
 	<div id="customizer_add_control_active">
			<!-- <form id="customizer_add_control_form" action=""> -->
  			<ul class="customize-section-content">
					<li class="customize-control customize-control-text">
						...
						<input form="customizer_add_control_form" type="hidden" value='prefixo' id='customizer_add_prefix' name='customizer_add_prefix'   />
						<label for="customizer_add_label"><span class="customize-control-title">Label</span>
							<input form="customizer_add_control_form" type="text" id="customizer_add_label" name="customizer_add_label" placeholder="Visible to users"   />
						</label>
					</li>
					<li class="customize-control customize-control-text">
            <label for="customizer_add_id"><span class="customize-control-title">Unique ID</span>
							<input form="customizer_add_control_form" type="text" id="customizer_add_id" name="customizer_add_id" class="customizer-type-id"   />
						</label>
					</li>
					<li class="customize-control customize-control-text">
        ...
        <input form="customizer_add_control_form" type="submit" value="Save Control" class="button-primary" id="customizer_submit_control_form">
      <!-- </form> -->
  </div>
<?php
	...
	if (isset( $ix['serialize'] ) && $ix['serialize'] == 'on'){
