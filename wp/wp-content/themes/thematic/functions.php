...
add_action('woocommerce_before_main_content', 'thematic_start', 10);
add_action('woocommerce_after_main_content', 'thematic_end', 10);

function thematic_start() {
    echo '<div id="container">';
}

function thematic_end() {
    echo '</div>';
}
